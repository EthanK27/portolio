export const projects = [
    ...
    },
    {
        id: "tictactoe",
        title: "Tic-Tac-Toe",
        summary: "Tic tac toe created using HTML, CSS, JS",
        description:
            "A simple version of tic-tac-toe that was created using HTML, CSS, and JavaScript and published using Netlify.",
    ...
    },
    {
        id: "memory",
        title: "Memory",
        summary: "A card flipping memory game",
        description:
            "A simple memory game based on flipping cards. Flip cards to increase your score and press reset to shuffle the cards and start over.",
        tech: ["JavaScript", "HTML", "CSS"],
